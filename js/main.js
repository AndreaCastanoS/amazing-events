    ...
    <div class="col-md-1  pb-5  container-fluid "  style="width: 20rem; background-color: #ffccfe; "  >
      <div class="card" style="background-color: #550053; " >
          <img src="${array.image}"
              ...
              <h4 class= "d-flex justify-content-md-center  rounded-5" style="background-color: #ffccfe; color: #550053; " >${array.category}</h4> 
...
events.forEach((element) => addCards(element));
...
let newEvent = newEve.reduce((a, b) => a.concat(b), []).sort();
